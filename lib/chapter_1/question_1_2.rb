...
def permutation?(str1, str2)
  ...
  str1.each_char do |char|
    if character_counts.has_key?(char)
  ...
  str2.each_char do |char|
    ...
    return false unless character_counts.has_key?(char)

    character_counts[char] -= 1

    # If the count goes negative, the str2 has more of char than str1
    return false if character_counts[char].negative?
  end
  
  # If any characters remain in character_counts, str1 and str2 have different
  #   characters
